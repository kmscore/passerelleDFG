...
@export_range(-90.0, 0.0, 0.1, "radians_as_degrees") var min_vertical_angle: float = deg_to_rad(-20)
@export_range(0.0, 5.0, 0.1, "radians_as_degrees") var max_vertical_angle: float = deg_to_rad(60)
@export var max_zoom_out: float = 2.0
...
func camera_zoom_out() -> void:
	spring_arm_3d.spring_length += zoom_out_step
	spring_arm_3d.spring_length = clampf(spring_arm_3d.spring_length, max_zoom_in, max_zoom_out)
